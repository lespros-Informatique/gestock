...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 04 fév. 2026 à 18:25
...
ALTER TABLE `fournisseurs`
  ADD CONSTRAINT `fournisseurs_ibfk_1` FOREIGN KEY (`boutique_code`) REFERENCES `boutiques` (`code_boutique`) ON DELETE RESTRICT ON UPDATE RESTRICT;
