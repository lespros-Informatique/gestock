<div class="card mt-2 bg_light">
    ...
    <button class="btn btn-info pull-right" id="markAddModal" > <i class="fa fa-plus-circle"></i>&nbsp; &nbsp; Ajouter</button>
...
<!-- Modal -->
<div class="modal fade" id="mark-modal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="markModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content ">
      <div class="modal-header">
        <h5 class="modal-title text-dark" id="markModalLabel"><i class="fa fa-user-circle"></i> &nbsp; <span class="text-uppercase">mark</span>  </h5>
