...
<div class="row mt-4 mb-4">
    ...
    <div class="col-md-4 mt-1 mb-1">
      ...
      <i style="position: absolute; bottom: 10px; right: 15px; font-size: 25px;" class="fa fa-calendar search-date-salaire" aria-hidden="true"></i>
...
<div class="card mt-1 bg_light">
  ...
  <div class="row mx-2 mt-2">
    ...
    <div class="col-md-12 mt-1 mb-2">
      ...
      <button type="button" data-periode="<?=$periode?>" class="btn btn-default" id="btn_imprimer_liste_salaire"> <i class="fa fa-print"></i> IMPRIMER </button>
          
      </div>

      <div class="form-group">
      <button type="button" class="btn btn-info " id="btn_ajouter_salaire"> <i
